...

      {
          ...
          <div id="sign-in-button"></div>
        {
            ...
            <TextField
              ...
              autoFocus
              value={mobile.number}    onChange={handleChange('number')}
            /> : !profile ?
            <TextField
            variant="outlined"
            margin="normal"
            ...
            value={mobile.otp}    onChange={handleChange('otp')}
            autoFocus
          ...
          value={mobile.profile}    onChange={handleChange('profile')}
          autoFocus
...
Submit
         ...
         >
          ...
          <Grid container>
            ...
            <Grid item>
              <Link to="/" onClick={()=>setlogin(true) } style={{cursor:'pointer'}}  variant="body2">
...
<Link to="/homepage">
       ...
       >login
        ...
        <Grid container>
          ...
          <Grid item>
            <Link to="/" onClick={()=>setlogin(false) } style={{cursor:'pointer'}}  variant="body2">
